...
## Download and edit https://github.com/archandanime/Arch-files/blob/master/Procedure/scanned-document-info.odt
wget https://github.com/archandanime/Arch-files/raw/master/Procedure/scanned-document-info.odt
## Merge pdf
